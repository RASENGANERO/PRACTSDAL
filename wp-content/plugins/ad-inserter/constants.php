...
if (file_exists (AD_INSERTER_PLUGIN_DIR.'includes/custom.php')) {
  include_once AD_INSERTER_PLUGIN_DIR.'includes/custom.php';
}
...
if (!defined( 'AD_INSERTER_VERSION'))
  define ('AD_INSERTER_VERSION', '2.7.35');
...
define ('AI_OPTION_STICKY',                      'sticky');
define ('AI_OPTION_STICKY_HEIGHT',               'sticky_height');
...
// JavaScript code
define ('AI_JAVASCRIPT_CODE_INLINE',   0);
define ('AI_JAVASCRIPT_CODE_FILE',     1);
...
define ('AI_TEXT_ENG_INLINE',       'Inline');
define ('AI_TEXT_ENG_FILE',         'File');
...
define ('DEFAULT_DYNAMIC_BLOCKS',               AI_DYNAMIC_BLOCKS_CLIENT_SIDE_INSERT);
...
define ('DEFAULT_CLIENT_SIDE_ACTION',           AI_CLIENT_SIDE_ACTION_INSERT);
