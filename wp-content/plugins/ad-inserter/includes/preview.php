...
function generate_code_preview (
  ...
  $sticky_block         = isset ($preview_parameters ['sticky_block'])      ? $preview_parameters ['sticky_block']      : $obj->get_sticky ();
  $sticky_height        = isset ($preview_parameters ['sticky_height'])     ? $preview_parameters ['sticky_height']     : $obj->get_sticky_height ();
  ...
  $obj->wp_options [AI_OPTION_STICKY]               = $sticky_block;
  $obj->wp_options [AI_OPTION_STICKY_HEIGHT]        = $sticky_height;
  ...
  if ($sticky_block) {
    ...
    if (!empty ($sticky_height)) {
      ...
      $block_code = '<div style="position: sticky; top: ' . ((int) get_sticky_widget_margin ()) .'px;">'."\n" . $block_code . '</div>'."\n" . '<div style="' . $style . '"></div>'."\n";
    }
  }
  ...
  function initialize_preview () {
    ...
    function load_preview_block () {
      ...
      var param = {
        ...
        'sticky_block':       <?php echo $sticky_block ? '1' : '0'; ?>,
        'sticky_height':      parseInt ('<?php echo $sticky_height ?>'),
        'close':              close_button,
