...
//  var ai_debug = false;
  ...
  if (ai_debug) {
    console.log ('AI FALLBACK ADSENSE UNFILLED:', adsense_unfilled_ins.closest ('.' + ai_block_class_def).classList.value, !!fallback_div.getAttribute ('data-code') ? 'INSERT' : 'SHOW');
  }
}
