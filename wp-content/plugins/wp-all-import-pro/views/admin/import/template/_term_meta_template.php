...
<div class="wpallimport-collapsed closed wpallimport-section wpallimport-custom-fields">
	<div class="wpallimport-content-section">
		<div class="wpallimport-collapsed-header">
			<h3><?php _e('Term Meta','wp_all_import_plugin');?></h3>
		</div>
			...
			<div class="wpallimport-collapsed-content-inner">
				...
				<div class="input cf_welcome">
					<?php if ( ! empty($meta_keys) ):?>
						<h1 style="font-size:23px; color:#40acad;"><?php printf(__('Your website is using Term Meta to store data for %s.', 'wp_all_import_plugin'), $custom_type->labels->name); ?></h1>
						...
						<td colspan="3" style="padding-top:20px;">
							...
							<table class="form-table custom-params" style="max-width:none; border:none;">
								...
								<tbody>
														...
														<fieldset>
															<table cellpadding="0" cellspacing="5" class="cf-form-table" rel="serialized_<?php echo $i; ?>">
																...
																<tbody>
																	...
																	<tr>
																		<td colspan="3">
																			<a href="javascript:void(0);" title="<?php _e('Add Term Meta', 'wp_all_import_plugin')?>" class="action add-new-key add-new-entry"><?php _e('Add Another', 'wp_all_import_plugin') ?></a>
																		</td>
																	</tr>
																	<tr>
																		<td>
									...
									<tr>
										<td colspan="2"><a href="javascript:void(0);" title="<?php _e('Add Term Meta', 'wp_all_import_plugin')?>" class="action add-new-custom add-new-entry"><?php _e('Add Term Meta', 'wp_all_import_plugin') ?></a></td>
									</tr>
								</tbody>
							</table>
