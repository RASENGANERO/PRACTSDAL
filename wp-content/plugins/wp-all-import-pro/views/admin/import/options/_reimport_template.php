		...
		if ( "new" == $post['wizard_type']): ?>
			<?php
				...
				else
				{
					...
					{
						?>
						<h3 style="padding-left:0;"><?php printf(__('WP All Import will create new %s for each unique record in this import file.','wp_all_import_plugin'), $custom_type->labels->name);?></h3>
						<?php
					}
				}
			?>
						...
						<tr>
							<td>
								<div class="input" style="margin-bottom:15px; position:relative;">
									...
									<h4><?php printf(__('Records in this import file will be matched with %ss on your site based on...', 'wp_all_import_plugin' ), $custom_type->labels->singular_name);?></h4>
