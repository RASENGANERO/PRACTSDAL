									...
									<div style="margin-left: -4px;">
										<div class="input">
											<div class="input">
												...
												<label for="duplicate_indicator_title"><?php _e('Name', 'wp_all_import_plugin' )?></label>
											</div>
											<div class="switcher-target-duplicate_indicator_title" style="padding-left:17px;">
												<input type="text" name="title_xpath" value="<?php echo empty($post['title_xpath']) ? esc_attr($post['title']) : esc_attr($post['title_xpath']) ?>" />
											</div>
											<div class="input">
												<input type="radio" id="duplicate_indicator_slug" class="switcher" name="duplicate_indicator" value="slug" <?php echo 'slug' == $post['duplicate_indicator'] ? 'checked="checked"': '' ?>/>
											...
											<div class="input">
												...
												<label for="duplicate_indicator_pid"><?php _e('Term ID', 'wp_all_import_plugin' )?></label>
											</div>
