...
<div class="wpallimport-submit-buttons">
	...
	<?php if ($isWizard): ?>
		...
		<a href="<?php echo apply_filters('pmxi_options_back_link', esc_url(add_query_arg('action', 'template', $this->baseUrl), $isWizard)); ?>" class="back rad3"><?php _e('Back to Step 3', 'wp_all_import_plugin') ?></a>
	...
	<?php else: ?>		
		<a href="<?php echo apply_filters('pmxi_options_back_link', esc_url(remove_query_arg('id', remove_query_arg('action', $this->baseUrl))), $isWizard); ?>" class="back rad3"><?php _e('Back to Manage Imports', 'wp_all_import_plugin') ?></a>
