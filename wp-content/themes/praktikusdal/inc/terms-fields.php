...
add_action('category_edit_form_fields', 'otchet_term_custom_fields', 10, 2);
add_action('post_tag_edit_form_fields', 'otchet_term_custom_fields', 10, 2);
function otchet_term_custom_fields($term, $taxonomy)
{
	global $category_meta_data;
...
add_action('edited_category', 'otchet_edited_term');
add_action('edited_post_tag', 'otchet_edited_term');
function otchet_edited_term($term_id)
{
	global $category_meta_data;
	foreach ($category_meta_data as $meta_key => $meta_field_data)
	{
