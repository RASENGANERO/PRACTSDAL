...
<html <?php language_attributes(); ?>>
	...
	<body <?php body_class(); ?>>
		...
		<div id="page" class="site">
			<a class="skip-link screen-reader-text" href="#content"><!--noindex--><?php esc_html_e( 'Skip to content', THEME_TEXTDOMAIN ); ?><!--/noindex--></a>
			...
			<?php
				...
				<?php if (is_active_sidebar('sidebar-5') && !is_front_page()) : ?>
    <div class="site-content-inner withr">
<?php else : ?>
