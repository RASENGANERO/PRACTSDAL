...
$thumbnail_size = 'full';
if ( wp_is_mobile() ) {
    $thumbnail_size = 'reboot_standard';
}
$thumbnail_size = apply_filters( '', $thumbnail_size );

$thumb_url = get_the_post_thumbnail_url( $post, $thumbnail_size );
...
?>
    ...
    <?php echo do_shortcode('[ccbd_other_services]'); ?>
