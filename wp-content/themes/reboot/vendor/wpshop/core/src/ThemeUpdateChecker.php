 ...
 * @access public
 *
 * @updated 2021-03-17 fix injectUpdate() Fatal error: Uncaught Error: Attempt to modify property "response" on bool
 */
class ThemeUpdateChecker {
	...
	public function injectUpdate($updates){
		...
		if ( is_object($updates) && !empty($state) && isset($state->update) && !empty($state->update) ){
