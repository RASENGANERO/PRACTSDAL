...
function wpshop_enqueue() {
    ...
    $fonts_options = array(
        'typography_body', 'typography_site_title', 'typography_site_description', 'typography_top_menu', 'typography_menu_links', 'typography_header_h1', 'typography_header_h2', 'typography_header_h3', 'typography_header_h4', 'typography_header_h5', 'typography_header_h6',
    );
