...
require get_template_directory() . '/inc/widgets/widget-table-of-contents.php';
...
function wpshop_widgets_register() {
    ...
    register_widget( 'Wpshop_Widget_Table_Of_Contents' );
...
class Vetteo_Widget_Classes {
    ...
    function extend_widget_form( $widget, $return, $instance ) {
        ...
        $fields = '';
        $fields .= "\t<p><label for='widget-{$widget->id_base}-{$widget->number}-classes'>".apply_filters( 'widget_css_classes_class', esc_html__( 'CSS Classes', THEME_TEXTDOMAIN ) ).":</label>
