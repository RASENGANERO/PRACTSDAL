...
class Wpshop_Widget_Articles extends WP_Widget {
    ...
    public function widget( $args, $instance ) {
        ...
        // Number of posts
        $post_limit = ( ! empty( $instance['post_limit'] ) ) ? trim( $instance['post_limit'] ) : 5;
        ...
        $hide_thumbnail = ! empty( $instance['hide_thumbnail'] ) ? $instance['hide_thumbnail'] : '';
        ...
        $hide_comments_count = ! empty( $instance['hide_comments_count'] ) ? $instance['hide_comments_count'] : '';

        // Hide views
        global $hide_views_count;
        $hide_views_count = ! empty( $instance['hide_views_count'] ) ? $instance['hide_views_count'] : '';
        ...
        $articles = get_posts( apply_filters( 'wpshop_widget_articles:get_posts_args', $get_posts_args, $instance ) );

        global $single_post;

        echo '<div class="widget-articles">';

            foreach ( $articles as $single_post ) {
    ...
    public function form( $instance ) {
        ...
        <p>
            <input type="checkbox" id="<?php echo $this->get_field_id( 'hide_thumbnail' ) ?>" name="<?php echo $this->get_field_name( 'hide_thumbnail' ) ?>" value="1" <?php checked( $hide_thumbnail ) ?>>
            <label for="<?php echo $this->get_field_id( 'hide_thumbnail' ) ?>"><?php echo __( 'Hide thumbnail', THEME_TEXTDOMAIN ) ?></label>
        </p>
        <p>
        ...
        <p>
            <input type="checkbox" id="<?php echo $this->get_field_id( 'hide_description' ) ?>" name="<?php echo $this->get_field_name( 'hide_description' ) ?>" value="1" <?php checked( $hide_description ) ?>>
            <label for="<?php echo $this->get_field_id( 'hide_description' ) ?>"><?php echo __( 'Hide description', THEME_TEXTDOMAIN ) ?></label>
        </p>
        <p>
            <input type="checkbox" id="<?php echo $this->get_field_id( 'hide_comments_count' ) ?>" name="<?php echo $this->get_field_name( 'hide_comments_count' ) ?>" value="1" <?php checked( $hide_comments_count ) ?>>
            <label for="<?php echo $this->get_field_id( 'hide_comments_count' ) ?>"><?php echo __( 'Hide comments count', THEME_TEXTDOMAIN ) ?></label>
        </p>
        <p>
            <input type="checkbox" id="<?php echo $this->get_field_id( 'hide_views_count' ) ?>" name="<?php echo $this->get_field_name( 'hide_views_count' ) ?>" value="1" <?php checked( $hide_views_count ) ?>>
            <label for="<?php echo $this->get_field_id( 'hide_views_count' ) ?>"><?php echo __( 'Hide views count', THEME_TEXTDOMAIN ) ?></label>
        </p>
        <p>
    ...
    public function update( $new_instance, $old_instance ) {
        ...
        $instance['hide_thumbnail']      = ! empty( $new_instance['hide_thumbnail'] ) ? true : false;
        $instance['hide_category']       = ! empty( $new_instance['hide_category'] ) ? true : false;
        $instance['hide_description']    = ! empty( $new_instance['hide_description'] ) ? true : false;
        $instance['hide_comments_count'] = ! empty( $new_instance['hide_comments_count'] ) ? true : false;
        $instance['hide_views_count']    = ! empty( $new_instance['hide_views_count'] ) ? true : false;
