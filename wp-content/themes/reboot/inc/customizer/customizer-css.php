...
function wpshop_customizer_css() {
    ...
    if ( $wpshop_core->get_option( 'arrow_position' ) == 'left' ) {
        $class_customizer_css->add(
            '.scrolltop',
            [ 'left: 10px', '' ]
        );
    ...
    $class_customizer_css->add(
        'a:hover, a:focus, a:active, .spanlink:hover, .entry-content a:not(.wp-block-button__link):hover, .entry-content a:not(.wp-block-button__link):focus, .entry-content a:not(.wp-block-button__link):active, .top-menu ul li>a:hover, .top-menu ul li>span:hover, .main-navigation ul li a:hover, .main-navigation ul li span:hover, .footer-navigation ul li a:hover, .footer-navigation ul li span:hover, .comment-reply-link:hover, .pseudo-link:hover, .child-categories ul li a:hover',
    ...
    $class_customizer_css->add(
        '.top-menu',
        [ 'typography', 'typography_top_menu' ]
    );
